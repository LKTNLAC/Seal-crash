...
pygame.display.set_caption('Save Seal')

# image
bg = pygame.image.load('Media/background.jpg')
carimg = pygame.image.load('Media/Seal.jfif')
...
def score_board(dodged):
    ...
    text = font.render('Scores: ' + str(dodged),True,BLACK)
    wn.blit(text,(0,0)) 

def crash():
    font = pygame.font.Font(None,80) 
    text = font.render('Seal is dead bro!',True,BLACK)
